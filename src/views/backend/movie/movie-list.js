...
//   const fetchFilteredData = useCallback((filterCriteria) => {
//     const { genre } = filterCriteria;
...
//       if (userInteracted) {
//         // Fetch data only if the user has interacted
//         fetchFilteredData(filterCriteria);
//       }
//     },
//     [fetchFilteredData, userInteracted]
//   );
...
//       setMinImdb(data.min_imdb || null);
//       setMaxImdb(data.max_imdb || null);
//     } catch (error) {
